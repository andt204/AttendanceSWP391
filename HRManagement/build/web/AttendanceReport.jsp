                        ...
                        <div class="main-option-search">
                            <nav class="navbar navbar-light bg-light justify-content-between">
                                <form action="AttendanceReport" method="get" class="form-inline">
                                    ...
                                    <button class="btn btn-outline-success my-2 my-sm-0" type="submit" style="height: 30px;">Search</button>
                                </form>
                            </nav>
                        </div>
                    </div>
                                                ...
                                                <td class="text-right">
                                                    <div class="dropdown dropdown-action">
                                                        ...
                                                        <div class="dropdown-menu dropdown-menu-right">
                                                            ...
                                                            <a class="dropdown-item" href="deleteAttendance?id=${o.attendance_id}" data-toggle="modal" data-target="#delete_attendance"><i class="fa fa-trash-o m-r-5"></i> Delete</a>
